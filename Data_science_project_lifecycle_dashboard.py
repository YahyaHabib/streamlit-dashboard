...
# Creating the dual-axis bar and line chart using Matplotlib
fig, ax1 = plt.subplots(figsize=(8, 5))
ax1.bar(filtered_country_data['Year'], filtered_country_data['Premature_Death_Count'], color='#4E79A7', label='Premature Death Count')
ax1.set_xlabel('Year')
ax1.set_ylabel('Premature Death Count', color='#4E79A7')
ax1.tick_params(axis='y', labelcolor='#4E79A7')

ax2 = ax1.twinx()
ax2.plot(filtered_country_data['Year'], filtered_country_data['Urban wastewater, all sources, discharged without treatment(million m3)'], color='#F28E2B', marker='o', label='Urban Wastewater (million m3)')
ax2.set_ylabel('Urban Wastewater (million m3)', color='#F28E2B')
ax2.tick_params(axis='y', labelcolor='#F28E2B')

plt.title('Premature Death Count and Urban Wastewater Discharged')
